...
void setRTC() {
  ...
  myRTC.updateTime();
  ShowValue(myRTC.hours, myRTC.minutes, 1);
  while (read_LCD_buttons() == btnNONE);
  ChooseValueSetRTC(myRTC.hours, myRTC.minutes, 1);
  lcd.setCursor(0,0);
...
void setPin() {
  ...
  while (read_LCD_buttons() == btnNONE);
  ChooseValue(eepromHour, eepromMin, adr1ON, 0);
  ...
  while (read_LCD_buttons() == btnNONE);
  ChooseValue(eepromHour, eepromMin, adr1OF, 1);
  ...
  ShowValue(eepromHour, eepromMin, 0);
  while (read_LCD_buttons() == btnNONE);
   ChooseValue(eepromHour, eepromMin, adr2ON, 0);
  ...
  ShowValue(eepromHour, eepromMin, 1);
  while (read_LCD_buttons() == btnNONE);
  ChooseValue(eepromHour, eepromMin, adr2OF, 1);
  ...
  ShowValue(eepromHour, eepromMin, 0);
  while (read_LCD_buttons() == btnNONE);
  ChooseValue(eepromHour, eepromMin, adr3ON, 0);
  ...
  ShowValue(eepromHour, eepromMin, 1);
  while (read_LCD_buttons() == btnNONE);
  ChooseValue(eepromHour, eepromMin, adr3OF, 1);
  ...
  ShowValue(eepromHour, eepromMin, 0);
  while (read_LCD_buttons() == btnNONE);
  ChooseValue(eepromHour, eepromMin, adr4ON, 0);
  ...
  ShowValue(eepromHour, eepromMin, 1);
  while (read_LCD_buttons() == btnNONE);
  ChooseValue(eepromHour, eepromMin, adr4OF, 1);
...
void ChooseValue(int HourNew, int MinNew, byte Address, byte Pos)
{
...
void  ChooseValueSetRTC(int HourNew, int MinNew, byte Pos)
{
  while (read_LCD_buttons() != btnSELECT)
{
    if (read_LCD_buttons() == btnRIGHT) 
...
void ShowValue(int Hour, int Min, int Pos)
{
